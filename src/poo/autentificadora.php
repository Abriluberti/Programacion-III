...
{
    private static string $secret_key = 'uberti.abril'; //firmo con mi apellido
    private static array $encrypt = ['HS256'];
    private static string $aud = "";

    
    public static function crearJWT( $data, int $exp = (60*2)) : string //tiempo que expira
    {
        $time = time();
        self::$aud = self::aud();
